    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center mb-8 lg:mb-16">
                ...
                <p class="font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Gestión de personal del sistema
                </p>
            </div>
                    ...
                    <div class="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                        <a href="/admins/{{ $admin->id }}/ver" class="w-full sm:w-48 h-48 flex-shrink-0">
                            <img class="w-full h-full rounded-lg sm:rounded-none sm:rounded-l-lg object-cover"
                                src="{{ asset('storage/img/admins/' . $admin->foto) }}" alt="{{ $admin->nombre }}">
                        </a>
                        <div class="p-5 w-full">
                            <h3 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a href="/admins/{{ $admin->id }}/ver">{{ $admin->nombre }}
                                    {{ $admin->apellido_paterno }}</a>
                            </h3>
                            ...
                            <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">Estado:
                                <span
                                    class="{{ $admin->estado == 'activo' ? 'text-green-600' : 'text-red-600' }} font-semibold">
