...
<head>
    ...
    <style>
        ...
        .sidebar-active {
            @apply bg-blue-50 text-blue-600 dark:bg-gray-700 dark:text-white;
        }
    </style>
</head>
...
<body class="bg-gray-50 dark:bg-gray-900">
    ...
    <aside id="default-sidebar"
        ...
        aria-label="Sidenav">
        <div class="h-full px-4 py-6 overflow-y-auto bg-white border-r border-gray-100 shadow-xl dark:bg-gray-800 dark:border-gray-700 flex flex-col">
            ...
            <ul class="space-y-1.5 font-medium flex-1">
                <li>
                    <a href="/Inicio" class="flex items-center p-3 text-gray-600 rounded-xl transition-all group hover:bg-blue-50 hover:text-blue-600 dark:text-gray-300 dark:hover:bg-gray-700">
                        <svg class="w-5 h-5 transition duration-75 group-hover:text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="pt-4 mt-4 border-t border-gray-100 dark:border-gray-700">
                @if(Auth::guard('admin')->check())
                    <div class="flex items-center p-3 mb-4 bg-blue-50 dark:bg-gray-700/50 rounded-2xl">
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="flex items-center w-full p-3 text-red-600 transition-all rounded-xl group hover:bg-red-50">
                    ...
                    <div class="relative p-10 overflow-hidden bg-slate-900 rounded-3xl shadow-2xl">
                        <div class="relative z-10 flex flex-col md:flex-row items-center justify-between">
                            ...
                            <div class="mt-8 md:mt-0">
                                <img src="https://images.unsplash.com/photo-1507842217343-583bb7270b66?ixlib=rb-1.2.1&auto=format&fit=crop&w=400&q=80"
                                    alt="Library Image" class="w-48 h-48 rounded-2xl object-cover shadow-2xl border-4 border-slate-800 rotate-3 hover:rotate-0 transition-transform duration-300">
                            </div>
                        </div>
