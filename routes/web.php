...
Route::middleware(['auth:admin'])->group(function () {
    ...
    Route::post('/admins/{id}/inactivar',[AdministradorController::class, 'inactivar']);
    Route::post('/admins/{id}/activar',[AdministradorController::class, 'activar']);
    ...
    route::post('/clientes/{id}/inactivar',[ClienteController::class, 'inactivar']);
    route::post('/clientes/{id}/activar',[ClienteController::class, 'activar']);
    ...
    Route::post('/productos/{id}/inactivar',[ProductoController::class, 'inactivar']);
